...
def build_notebook():
    ...
    output_dir = 'd:/skillwallet/CreditCardApproval/notebooks'
    os.makedirs(output_dir, exist_ok=True)
    with open(os.path.join(output_dir, 'eda_and_modeling.ipynb'), 'w') as f:
        json.dump(notebook, f, indent=1)
    print("Notebook template successfully created!")
